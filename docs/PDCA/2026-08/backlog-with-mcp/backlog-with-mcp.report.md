...
| 0.2 | 2026-08-08 | **(사후 확인, refine-mcp-hardening 사이클 S6)** C7·C10을 claude.ai 웹 MCP 커넥터로 완주(F27) — §헤더·§1.2·§1.4·§4.2 반영. §4.1에서 Critical(처리일 삭제 불가)·Important(Origin 에러코드)·Minor(MCP 스키마 미재사용) 3건 해소 반영. 원문은 삭제하지 않고 취소선+사후 문구로 병기(D-25) | cogmo |
